{
    let view = {
        ...
        <div id="container" class="draggable">
            <div id="pickfiles" class="clickable">
                <span>点击或拖曳上传音频</span>
                    <p>文件大小不能超过40MB</p>
            </div>
        </div>
    ...
    let controller = {
        ...
        initQiniu() {
            var uploader = Qiniu.uploader({
                ...
                domain: 'http://piftgpcpy.bkt.clouddn.com', //bucket 域名，下载资源时用到，**必需**
                ...
                init: {
                    ...
                    'FileUploaded': function (up, file, info) {
                        ...
                        //uploadStatus.innerHTML = sourceLink + ' ' + response.key
                    },
